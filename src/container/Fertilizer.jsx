...
line-height: normal;
    ...
    `;
  return (
    <div className='bg-[#A2CFA4] pt-[60px] px-[60px]'>
    ...
    <div className='flex flex-row space-x-16 '>
        ...
        <p  className='text-[22px]'> Cultivate success with our scientifically formulated fertilizers, designed to enhance soil fertility and promote robust plant growth. Elevate your agricultural practices with confidence, 
...
nutrients that promote plant growth. These nutrients are crucial for the development and well-being
 ...
 There are three primary nutrients that plants require in relatively large amounts, known as macronutrients.
  These are:Nitrogen (N)   Phosphorus (P)   Potassium (K). <NavLink to="/fertilizerpage" className="text-[16px] relative top-[2px] text-gray-100"   >Read More...</NavLink></p>
